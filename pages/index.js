...
export default function Dashboard() {
  ...
  return (
    <div style={{ padding: '40px', fontFamily: 'sans-serif', backgroundColor: '#ffffff', color: '#0f172a', minHeight: '100vh' }}>
      ...
      <p style={{ color: '#64748b', marginBottom: '25px', fontWeight: '500' }}>Active Filter Results: {filteredCores.length} / {cores.length} Cores Found</p>

      {/* Control Configuration Filtering Matrices */}
      ...
      {loading ? <p style={{ color: '#2563eb', fontWeight: 'bold' }}>Mapping core attributes matrix...</p> : (
